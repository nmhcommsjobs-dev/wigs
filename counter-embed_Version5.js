(function() {
  ...
  style.innerHTML =
    ...
    ".nmh-counter-grid { " +
      ...
      "width: 100%;" +
      " }" +
    ".nmh-counter-item { text-align: center; padding: 1rem 0.2rem; background: #7E2D40; border-radius: 10px; box-shadow: 0 1px 8px rgba(126,45,64,0.07);" +
