(function() {
  ...
  style.innerHTML =
    ...
    ".nmh-counter-item { text-align: center; padding: 1rem 0.2rem; background: #7E2D40; border-radius: 10px; box-shadow: 0 1px 8px rgba(126,45,64,0.07); width: 70%; margin: 0 auto; }" +
    ".nmh-counter-number { font-size: 2em; font-weight: 700; color: #ffffff; margin-bottom: 0.45em; letter-spacing: 0.02em; line-height: 1.1; }" +
    ".nmh-counter-label { font-size: 1em; color: #ffffff; font-weight: 400; letter-spacing: 0.01em; }" +
